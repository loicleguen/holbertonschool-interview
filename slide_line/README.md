...
* The prototypes of all your functions should be included in your header file calledslide_line.h
* Don’t forget to push your header file
* All your header files should be include guarded

## Task
### 0. Slide line <a name='subparagraph0'></a>
