...
## Table of Contents :
  ...
  - [0. Advanced Binary Search](#subparagraph0)
...
* You are only allowed to use theprintffunction of the standard library. Any call to another function likestrdup,malloc, … is forbidden.
...
* The prototypes of all your functions should be included in your header file calledsearch_algos.h
* Don't forget to push your header file
* Your header file should be include guarded

## Task
### 0. Advanced Binary Search <a name='subparagraph0'></a>
